...
import { getAllProducts, getProductById, createProduct, updateProductController, updateStock, deleteProductController, getLowStock, getProductsByCategoryController, calculateMargin, getVariants, getVariantById, createVariant, updateVariantController, updateVariantStockController, deleteVariantController, getBatches, getBatchById, createBatch, updateBatchController, updateBatchStockController, deleteBatchController, getLowStockVariantsController, getLowStockBatchesController } from '../controllers/productcontroller.js';
