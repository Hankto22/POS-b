...
export const startUserShift = async (c) => {
    try {
...
export const endUserShift = async (c) => {
    try {
...
export const getUserShifts = async (c) => {
    try {
        const user = c.get('user');
...
export const getAllShifts = async (c) => {
    try {
