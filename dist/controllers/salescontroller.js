import { fetchSales, fetchSalesByDateRange, addSale, calculateTotalRevenue, getTopSellingProducts, getSalesByCustomer, createTransaction, fetchTransactions } from '../services/salesService.js';
...
export const getSalesByDateRange = async (c) => {
    try {
...
export const getTotalRevenue = async (c) => {
    try {
...
export const getTopProducts = async (c) => {
    try {
...
export const getCustomerSales = async (c) => {
    try {
