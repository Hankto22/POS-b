...
// Variant controllers
export const getVariants = async (c: Context) => {
  try {
...
export const getVariantById = async (c: Context) => {
  try {
    const id = c.req.param('id');
...
export const updateVariantController = async (c: Context) => {
  try {
    const id = c.req.param('id');
    const body = await c.req.json();
...
export const updateVariantStockController = async (c: Context) => {
  try {
    const id = c.req.param('id');
    const { stock } = await c.req.json();
...
export const deleteVariantController = async (c: Context) => {
  try {
    const id = c.req.param('id');
...
// Batch controllers
export const getBatches = async (c: Context) => {
  try {
...
export const updateBatchController = async (c: Context) => {
  try {
    const id = c.req.param('id');
    const body = await c.req.json();
...
export const updateBatchStockController = async (c: Context) => {
  try {
    const id = c.req.param('id');
    const { stock } = await c.req.json();
...
export const deleteBatchController = async (c: Context) => {
  try {
    const id = c.req.param('id');
...
export const getLowStockVariantsController = async (c: Context) => {
  try {
    const threshold = parseInt(c.req.query('threshold') || '3');
...
export const getLowStockBatchesController = async (c: Context) => {
  try {
    const threshold = parseInt(c.req.query('threshold') || '3');
